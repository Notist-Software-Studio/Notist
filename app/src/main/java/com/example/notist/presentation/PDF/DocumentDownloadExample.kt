...
class DocumentDownloadExample(context: Context) {
    ...
    fun launchExample(context: Context, configuration: PdfActivityConfiguration.Builder) {
        ...
        val source: WebDownloadSource = try {
            ...
            WebDownloadSource(URL("https://firebasestorage.googleapis.com/v0/b/notist-2d957.appspot.com/o/pdfs%2F1Zfnw66vHA9JsscFacW2%2Fsample.pdf?alt=media&token=b1a0a1fe-dd9a-4bb8-a32e-3d837b303eb4"))
...
open class PSPDFExample(context: Context, s: String, s1: String) {
