...
data class State(
    ...
    val preferences: Map<Preferences.Key<*>, Any> = mapOf(
        ...
        Pair(PreferenceKeys.PreferredLanguage, PSPDFExample.ExampleLanguage.KOTLIN.name),
...
val State.preferredLanguage: String
    get() =
        preferences[PreferenceKeys.PreferredLanguage] as String
